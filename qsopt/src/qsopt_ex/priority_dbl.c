...
void dbl_ILLutil_priority_free (
	dbl_ILLpriority * pri)
{
...
void dbl_ILLutil_priority_findmin (
	dbl_ILLpriority * pri,
	double * keyval,
	void **en)
{
...
int dbl_ILLutil_priority_insert (
	dbl_ILLpriority * pri,
	void *data,
	double * keyval,
	int *handle)
{
	...
	if (pri->freelist == -1)
	{
		...
		pri->pri_info =
			EGrealloc (pri->pri_info, sizeof (union dbl_ILLpri_data) * newsize);
		//rval = ILLutil_reallocrus_count ((void **) &pri->pri_info, newsize,
		//                                 sizeof (union dbl_ILLpri_data));
		//ILL_CLEANUP_IF (rval);
...
void dbl_ILLutil_priority_delete (
	dbl_ILLpriority * pri,
	int handle)
{
...
void dbl_ILLutil_priority_deletemin (
	dbl_ILLpriority * pri,
	double * keyval,
	void **en)
{
...
void dbl_ILLutil_priority_changekey (
	dbl_ILLpriority * pri,
	int handle,
	double * newkey)
{
