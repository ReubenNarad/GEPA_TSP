...
int mpf_ILLformat_error_create (
...
void mpf_ILLformat_error_delete (
	mpf_qsformat_error * error)
{
...
void mpf_ILLformat_error_print (
	EGioFile_t * out,
	mpf_qsformat_error * error)
{
	int at = error->at;
...
mpf_qserror_collector *mpf_ILLerror_collector_new (
	mpf_qsadd_error_fct fct,
	void *dest)
{
	int rval = 0;
...
mpf_qserror_collector *mpf_ILLerror_memory_collector_new (
	mpf_qserror_memory * dest)
{
	return mpf_ILLerror_collector_new (mpf_ILLadd_error_to_memory, dest);
}

void mpf_ILLerror_collector_free (
	mpf_qserror_collector * c)
{
	ILL_IFFREE (c, mpf_qserror_collector);
}

mpf_qserror_memory *mpf_ILLerror_memory_create (
	int takeErrorLines)
{
	int rval = 0, i;
...
int mpf_ILLadd_error_to_memory (
	void *dest,
