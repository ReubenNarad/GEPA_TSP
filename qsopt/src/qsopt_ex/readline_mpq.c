...
/* #ifdef _WINDOWS*/
mpq_qsline_reader *mpq_ILLline_reader_new (
	mpq_qsread_line_fct fct,
	void *data_src)
{
	mpq_qsline_reader *reader;
	int rval = 0;

	ILL_NEW (reader, mpq_qsline_reader);
	if (reader != NULL)
	{
...
void mpq_ILLline_reader_free (
	mpq_qsline_reader * reader)
{
	ILL_IFFREE (reader, mpq_qsline_reader);
}
