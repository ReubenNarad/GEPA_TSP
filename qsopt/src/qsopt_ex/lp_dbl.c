...
/*  EXPORTED FUNCTIONS                                                      */
/*                                                                          */
/*        int dbl_ILLwrite_lp (EGioFile_t *out, dbl_ILLlpdata *lp)                  */
/*        int dbl_ILLread_lp (dbl_qsline_reader f, const char *fname, dbl_rawlpdata *lp)*/
 ...
 */
	...
	rval = dbl_ILLread_lp_state_init (state, file, fname, 0);
	CHECKRVALG (rval, CLEANUP);
