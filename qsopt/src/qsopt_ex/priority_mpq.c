...
void mpq_ILLutil_priority_free (
	mpq_ILLpriority * pri)
{
...
void mpq_ILLutil_priority_findmin (
	mpq_ILLpriority * pri,
	mpq_t * keyval,
	void **en)
{
...
int mpq_ILLutil_priority_insert (
	mpq_ILLpriority * pri,
	void *data,
	mpq_t * keyval,
	int *handle)
{
	...
	if (pri->freelist == -1)
	{
		...
		pri->pri_info =
			EGrealloc (pri->pri_info, sizeof (union mpq_ILLpri_data) * newsize);
		//rval = ILLutil_reallocrus_count ((void **) &pri->pri_info, newsize,
		//                                 sizeof (union mpq_ILLpri_data));
		//ILL_CLEANUP_IF (rval);
...
void mpq_ILLutil_priority_delete (
	mpq_ILLpriority * pri,
	int handle)
{
...
void mpq_ILLutil_priority_deletemin (
	mpq_ILLpriority * pri,
	mpq_t * keyval,
	void **en)
{
...
void mpq_ILLutil_priority_changekey (
	mpq_ILLpriority * pri,
	int handle,
	mpq_t * newkey)
{
