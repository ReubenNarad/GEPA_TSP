...
mpq_QSLIB_INTERFACE int mpq_QSopt_primal (
	mpq_QSdata * p,
	int *status)
{
	int rval = 0;
...
mpq_QSLIB_INTERFACE mpq_QSdata *mpq_QScreate_prob (
	const char *name,
	int objsense)
{
	int rval = 0;
...
mpq_QSLIB_INTERFACE mpq_QSdata *mpq_QScopy_prob (
	mpq_QSdata * p,
	const char *newname)
{
	int rval = 0;
...
mpq_QSLIB_INTERFACE int mpq_QSload_basis (
	mpq_QSdata * p,
	QSbasis * B)
{
	int rval = 0;
...
mpq_QSLIB_INTERFACE int mpq_QSwrite_basis (
	mpq_QSdata * p,
	QSbasis * B,
	const char *filename)
{
