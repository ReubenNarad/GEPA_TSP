...
mpf_QSLIB_INTERFACE int mpf_QSopt_primal (
	mpf_QSdata * p,
	int *status)
{
	int rval = 0;
...
mpf_QSLIB_INTERFACE mpf_QSdata *mpf_QScreate_prob (
	const char *name,
	int objsense)
{
	int rval = 0;
...
mpf_QSLIB_INTERFACE mpf_QSdata *mpf_QScopy_prob (
	mpf_QSdata * p,
	const char *newname)
{
	int rval = 0;
...
mpf_QSLIB_INTERFACE int mpf_QSload_basis (
	mpf_QSdata * p,
	QSbasis * B)
{
	int rval = 0;
...
mpf_QSLIB_INTERFACE int mpf_QSwrite_basis (
	mpf_QSdata * p,
	QSbasis * B,
	const char *filename)
{
