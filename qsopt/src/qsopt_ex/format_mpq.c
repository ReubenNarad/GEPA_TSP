...
int mpq_ILLformat_error_create (
...
void mpq_ILLformat_error_delete (
	mpq_qsformat_error * error)
{
...
void mpq_ILLformat_error_print (
	EGioFile_t * out,
	mpq_qsformat_error * error)
{
	int at = error->at;
...
mpq_qserror_collector *mpq_ILLerror_collector_new (
...
void mpq_ILLerror_collector_free (
	mpq_qserror_collector * c)
{
	ILL_IFFREE (c, mpq_qserror_collector);
}

mpq_qserror_memory *mpq_ILLerror_memory_create (
	int takeErrorLines)
{
	int rval = 0, i;
...
int mpq_ILLadd_error_to_memory (
	void *dest,
