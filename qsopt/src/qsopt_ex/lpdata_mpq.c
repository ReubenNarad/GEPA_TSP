...
void mpq_ILLstart ( void)
{
	...
	//mpq_EGlpNumInitVar (DJZERO_TOLER);
	...
	mpq_EGlpNumSet (mpq_PARAM_MIN_DNORM, 4.5036e-9);
	mpq_EGlpNumMultTo (mpq_PARAM_MIN_DNORM, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_PFEAS_TOLER, 4.5036e9);
	mpq_EGlpNumMultTo (mpq_PFEAS_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_BD_TOLER, 4.5036e8);
	mpq_EGlpNumMultTo (mpq_BD_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_DFEAS_TOLER, 4.5036e9);
	mpq_EGlpNumMultTo (mpq_DFEAS_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_PIVOT_TOLER, 4.5036e5);
	mpq_EGlpNumMultTo (mpq_PIVOT_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_SZERO_TOLER, 4.5036);
	mpq_EGlpNumMultTo (mpq_SZERO_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_PIVZ_TOLER, 4.5036e3);
	mpq_EGlpNumMultTo (mpq_PIVZ_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_OBJBND_TOLER, 4.5036e13);
	mpq_EGlpNumMultTo (mpq_OBJBND_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_ALTPIV_TOLER, 4.5036e7);
	mpq_EGlpNumMultTo (mpq_ALTPIV_TOLER, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_PROGRESS_ZERO, 4.5036e8);
	mpq_EGlpNumMultTo (mpq_PROGRESS_ZERO, mpq_epsLpNum);
	mpq_EGlpNumSet (mpq_PROGRESS_THRESH, 4.5036e10);
	mpq_EGlpNumMultTo (mpq_PROGRESS_THRESH, mpq_epsLpNum);
#if VERBOSE_LEVEL <= DEBUG
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PARAM_MIN_DNORM to %lg", mpq_EGlpNumToLf (mpq_PARAM_MIN_DNORM));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PFEAS_TOLER to %lg", mpq_EGlpNumToLf (mpq_PFEAS_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_BD_TOLER to %lg", mpq_EGlpNumToLf (mpq_BD_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_DFEAS_TOLER to %lg", mpq_EGlpNumToLf (mpq_DFEAS_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PIVOT_TOLER to %lg", mpq_EGlpNumToLf (mpq_PIVOT_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_SZERO_TOLER to %lg", mpq_EGlpNumToLf (mpq_SZERO_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PIVZ_TOLER to %lg", mpq_EGlpNumToLf (mpq_PIVZ_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_OBJBND_TOLER to %lg", mpq_EGlpNumToLf (mpq_OBJBND_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_ALTPIV_TOLER to %lg", mpq_EGlpNumToLf (mpq_ALTPIV_TOLER));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PROGRESS_ZERO to %lg", mpq_EGlpNumToLf (mpq_PROGRESS_ZERO));
	MESSAGE (VERBOSE_LEVEL, "Setting mpq_PROGRESS_THRESH to %lg", mpq_EGlpNumToLf (mpq_PROGRESS_THRESH));
#endif
	...
	//mpq_EGlpNumSet (DJZERO_TOLER, 1e-8);
...
void mpq_ILLend ( void)
{
	...
	mpq_EGlpNumClearVar (mpq_ALTPIV_TOLER);
	//mpq_EGlpNumClearVar (DJZERO_TOLER);
	...
	int isMps)
{
	...
	p = mpq_QScreate_prob (fname, QS_MIN);
	...
	if (isMps != 0)
	{
		rval = mpq_ILLread_mps (file, fname, &rawlp);
	}
	else
	{
		rval = mpq_ILLread_lp (file, fname, &rawlp);
	}
	...
	mpq_ILLlpdata * lp)
{
	if (lp)
	{
		...
		ILLstring_reporter_init(
			&lp->reporter, mpq_ILLlpdata_log, NULL);
	}
}
