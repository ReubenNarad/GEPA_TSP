...
int dbl_ILLformat_error_create (
...
void dbl_ILLformat_error_delete (
	dbl_qsformat_error * error)
{
...
void dbl_ILLformat_error_print (
	EGioFile_t * out,
	dbl_qsformat_error * error)
{
	int at = error->at;
...
dbl_qserror_collector *dbl_ILLerror_collector_new (
...
void dbl_ILLerror_collector_free (
	dbl_qserror_collector * c)
{
	ILL_IFFREE (c, dbl_qserror_collector);
}

dbl_qserror_memory *dbl_ILLerror_memory_create (
	int takeErrorLines)
{
	int rval = 0, i;
...
int dbl_ILLadd_error_to_memory (
	void *dest,
